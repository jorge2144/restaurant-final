(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.cartPrefix = "Restaurant-"; // Prefix string to be prepended to the cart's name in the session storage
			...
			this.paypalBusinessEmail = "ccjorge2144@email.com"; // Your Business PayPal's account email address
